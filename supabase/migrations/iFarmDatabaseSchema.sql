-- iFarm Complete Database Schema
-- Comprehensive livestock management system with enhanced features
-- Fixed version addressing generation expression immutability
...
BEGIN
    ...
    RAISE NOTICE '- Removed problematic generated column for age_months';
    RAISE NOTICE '- Age is now calculated dynamically in views and functions';
